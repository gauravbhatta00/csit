...
from .views import (
    ...
    EmailSubscriptionUnsubscribeView,
    GoogleLoginView,
    LogoutView,
...
urlpatterns = [
    ...
    path('email-subscriptions/unsubscribe/', EmailSubscriptionUnsubscribeView.as_view()),
    path('email-subscriptions/unsubscribe/<uuid:token>/', EmailSubscriptionUnsubscribeView.as_view()),
    ...
    path('admin/email/templates/', AdminEmailTemplateListView.as_view()),
    path('admin/email/templates/<int:pk>/', AdminEmailTemplateDetailView.as_view()),
    path('admin/email/campaigns/', AdminEmailCampaignView.as_view()),
